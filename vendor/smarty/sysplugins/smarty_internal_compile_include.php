...
class Smarty_Internal_Compile_Include extends Smarty_Internal_CompileBase
{
    ...
    public function compile($args, Smarty_Internal_SmartyTemplateCompiler $compiler, $parameter)
    {
        ...
        */
        ...
        if ($has_compiled_template && !$call_nocache) {
            ...
            $_output .= "\$_smarty_tpl->smarty->ext->_subtemplate->render(\$_smarty_tpl, {$fullResourceName}, {$_cache_id}, {$_compile_id}, {$_caching}, {$_cache_lifetime}, {$_vars}, {$_scope}, {$_cache_tpl}, '{$compiler->parent_compiler->mergedSubTemplatesData[$hashResourceName][$t_hash]['uid']}', '{$compiler->parent_compiler->mergedSubTemplatesData[$hashResourceName][$t_hash]['function']}');\n";
            if (isset($_assign)) {
                                          ...
                                          $_caching, $hashResourceName, $t_hash, $c_id)
    {
        ...
        if (!($tpl->source->handler->uncompiled) && $tpl->source->exists) {
            ...
            $compiler->parent_compiler->mergedSubTemplatesData[$hashResourceName][$t_hash]['function'] =
